#PCA in FactoMinR and factoextra
#November 27, 2018
#AMP
...
# PCA: summarizes information in multivariate data sets into PCs
# Ranks PCs in order of variance they explain
#reduces dimensionality of data sets, loses least amount of info as possible
